...
class TaskViewModel: ObservableObject {
    ...
    @Published var storedTasks: [Task] = [
        ...
        Task(taskTitle: "Meeting", taskDescription: "taskDescription", taskDate: Calendar.current.date(byAdding: .hour, value: 1, to: Date())!),
        Task(taskTitle: "Meeting", taskDescription: "taskDescription", taskDate: Calendar.current.date(byAdding: .hour, value: 2, to: Date())!),
